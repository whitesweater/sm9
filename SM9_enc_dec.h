...
#define SM9_ASK_MEMORY_ERR 0x00000001 //??????????
#define SM9_MEMBER_ERR 0x00000002 //???????
#define SM9_MY_ECAP_12A_ERR 0x00000003 //R-ate ???????????
#define SM9_C1_NOT_VALID_G1 0x00000004 //C1 ??????? G1
#define SM9_G1BASEPOINT_SET_ERR 0x00000005 //G1 ???????????
#define SM9_G2BASEPOINT_SET_ERR 0x00000006 //G2 ???????????
#define SM9_GEPUB_ERR 0x00000007 //??????????
#define SM9_GEPRI_ERR 0x00000008 //??????????
#define SM9_ENCRYPT_ERR 0x00000009 //???????
#define SM9_ERR_K1_ZERO 0x0000000A //K1 ? 0
#define SM9_C3_MEMCMP_ERR 0x0000000B //C3 ???????
#define SM9_DECRYPT_ERR 0x0000000C //???????
#define SM9_REKEYGEN_ERR 0x0000000D //???????
#define SM9_REVOKE_ERR 0x0000000E //???????
#define SM9_REENCRYPT_ERR 0x0000000F //???????
#define SM9_DECRYPT2_ERR 0x0000000G //???????
...
int k = 5;//用k表示,仍需要在SM9_ReKeyGen中修改k值
